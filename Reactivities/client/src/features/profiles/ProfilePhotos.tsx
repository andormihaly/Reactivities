...
import StarButton from "../../app/shared/components/StartButton";
...
export default function ProfilePhotos() {
    const { id } = useParams();
    const { photos, loadingPhotos, isCurrentUser, uploadPhoto, setMainPhoto, profile, deletePhoto } = useProfile(id);
