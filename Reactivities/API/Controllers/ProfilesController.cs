...
public class ProfilesController :BaseApiController
{
    ...
    public async Task<ActionResult<List<Photo>>> AddPhoto( string userId)
    {
    ...
    [HttpPut]
    public async Task<ActionResult> EditProfile(UserProfile profile)
    {
    ...
    {
        return HandleResult(await Mediator.Send(new FollowTogle.Command { TargetuserId = userId }));
    }
